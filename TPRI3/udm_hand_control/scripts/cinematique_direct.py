...
class kinematics_fingers:
    def __init__(self, group_name, joint1, joint2, joint3):
        ...
        rospy.init_node('direct_server', anonymous=True)
...
if __name__ == '__main__':
    kinematics_fingers('index', 0.0, 0.0, 0.0)
    kinematics_fingers('middle', 0.0, 0.0, 0.0)
    kinematics_fingers('ring', 0.0, 0.0, 0.0)
    kinematics_fingers('pinky', 0.0, 0.0, 0.0)
    kinematics_thumb('thumb', 0.0, 0.0)
